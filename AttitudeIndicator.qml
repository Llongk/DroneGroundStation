...
Rectangle {
        ...
        Rectangle {
            ...
            Canvas {
                ...
                onPaint: {
                    ...
                    ctx.moveTo(-w, root.pitch * 3);

                    ctx.lineTo(w, root.pitch * 3);
    ...
    Connections {
        ...
        function onGpsChanged() {
            root.pitch = backend.pitch;

            root.roll = backend.roll;

            root.yaw = backend.yaw;
